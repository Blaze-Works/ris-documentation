if (!window.frameElement && window.location.protocol !== 'file:') {
    ...
    let splitIndex = href.lastIndexOf('/docs/') + 6;
    let docsBaseURL = href.substr(0, splitIndex);
    ...
    let end = (extension === 'html') ? - 5 : href.length;
    let pathSnippet = href.slice(splitIndex, end);
...
function onDocumentLoad() {
    ...
    let styleCustom = document.createElement('link');
